...
public:
	...
	vec3 f(const IntersectionInfo& info, const vec3& i, const vec3& o, float& pdf) const override;
	float pdf(const IntersectionInfo& info, const vec3& i, const vec3& o) const override;
